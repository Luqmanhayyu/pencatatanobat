...
<body>
  ...
  <form action="/update/{{$data->id}}" method="post">
    ...
    <div class="mb-3">
      <label for="exampleInputEmail1" class="form-label">Deskripsi Obat</label>
      <input type="text" class="form-control" name="deskripsi_obat" value="{{$data->deskripsi_obat}}">
    </div>
    <div class="mb-3">
